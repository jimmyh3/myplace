            ...
            <?php foreach ($apartments as $apartment) {?>
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"> 
                        ...
                        <?php if( isset($apartment->thumbnail)) echo '<img src="data:image/jpeg;base64,'.base64_encode($apartment->thumbnail).'">';?>
                        <!-- <img src="http://placehold.it/320x150" alt=""> --> 
                        
                        <div class="caption">
                            <h4 class="pull-right"> $<?php if( isset($apartment->actual_price)) echo htmlspecialchars($apartment->actual_price, ENT_QUOTES, 'UTF-8');?></h4>
                            <h4><a href="#"> <?php if( isset($apartment->id)) echo htmlspecialchars($apartment->id, ENT_QUOTES, 'UTF-8');?> </a>
                            </h4>
                            <?php if( isset($apartment->description)) echo htmlspecialchars($apartment->description, ENT_QUOTES, 'UTF-8');?>
                        </div>
                        <div class="ratings">
