...
<div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail"> 
                            ...
                            <div class="ratings">
                                <button type="button" class="btn btn-primary btn-sm pull-right">Delete Post</button>
                               
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#aptModal">Edit Post</button>
...
$name = $name = $email = $number = $title = $bedroom = $price = $term = 
        $zipcode = $desc = $tag = "";
