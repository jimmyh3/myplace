...
<br>
        ...
        <div class="col-sm-4 col-lg-4 col-md-4">
            <div class="thumbnail">
                <?php 
                if(isset( $apartment->thumbnail)) echo '<img src="data:image/jpeg;base64,'.base64_encode( $apartment->thumbnail).'" alt="" style="cursor: pointer;height:150px;width:320px;" alt="">';
                else echo '<img src="http://placehold.it/320x150" alt="">';
                    ?>
