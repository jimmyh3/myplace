                ...
                <div class="navbar-collapse collapse" id="searchbar">
                    ...
                    <ul class="nav navbar-nav navbar-right"> ><!-- TODO fix bug with welcome button not rendering if not landlord-->
                        ...
                        <?php if(isset($_COOKIE["myPlace_userType"]) && $_COOKIE["myPlace_userType"] == 1){
                            echo '<a href="'.URL.'post" data-toggle="tooltip" data-placement="bottom" title="Manage Apartments"><span class="glyphicon glyphicon-home"></span> myPost</a>';
                        }else{
                            echo '<a data-toggle="tooltip" data-placement="bottom" title="MUST BE LANDLORD!"><span class="glyphicon glyphicon-home"></span> myPost</a>'; 
                        }
                        ?>
                        </li>
